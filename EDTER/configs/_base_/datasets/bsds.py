...
# data_root = 'D:/ywy/3.Dada&Code/Dataset/BSDS'  # data_root = '../data/BSDS'
data_root = 'D:/ywy/3.Dada&Code/Dataset/NYUD'
# data_root = 'D:/ywy/3.Dada&Code/Dataset/Pascal'
# data_root = ''
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        ...
        img_dir='',
        ann_dir='',
        split='ImageSets/bsds_pascal.lst',
