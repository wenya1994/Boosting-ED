...
def parse_args():
    ...
    parser.add_argument('--globalconfig', help='train config file path',
                        type=str, default='../configs/bsds/EDTER_BIMLA_320x320_80k_bsds_bs_8.py')
    parser.add_argument('--global-model-path', type=str, default='../checkpoints/EDTER-BSDS-VOC-StageI.pth',
                        help='the dir of the best global model')
    parser.add_argument('--config', help='train config file path',
                        type=str, default='../configs/bsds/EDTER_BIMLA_320x320_80k_bsds_local8x8_bs_8.py')
    parser.add_argument('--work-dir', help='the dir to save logs and models')
    parser.add_argument(
        '--load-from', help='the checkpoint file to load weights from')
    parser.add_argument(
        '--resume-from',  # type=str, default='../work_dirs/iter_2000.pth',
...
def main():
    ...
    if cfg.checkpoint_config is not None:  # schedule_80k.py 中设置 checkpoint_config = dict(by_epoch=False, interval=20)
