...
def parse_args():
    ...
    parser.add_argument('--config', type=str, default='../configs/bsds/EDTER_BIMLA_320x320_80k_bsds_bs_8.py',
                        help='train config file path')
    parser.add_argument('--checkpoint', type=str, default='../checkpoints/EDTER-BSDS-VOC-StageI.pth')
    parser.add_argument(
...
def main():
    ...
    if not distributed:
        ...
        # results = single_gpu_test(model, data_loader, args.show)
        results = single_gpu_test(model, data_loader, False)
